...
class Trade extends React.Component {
  ...
  return (
    <React.Fragment>
        ...
        <p>Our most recent engagement is: </p>
        <p>What started out as a pro bono community management engagement turned into an opportunity to <i>deeply embed</i> and join the founding team bootstrap
           the Settlement DAO.</p>
        {/* End Content */}
    </React.Fragment>
  );
  }
